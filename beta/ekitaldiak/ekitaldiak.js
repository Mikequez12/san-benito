	...
	let loading_data = setInterval(function() {
		if (window.loaded_data !== undefined) {
			setTimeout(function() {
				...
				let taldekatze_datak = document.querySelector('#hezkidetza #taldekatze-datak');
				...
				let ekitaldiak = document.querySelector('#hezkidetza #ekitaldiak');
				...
				document.querySelector('#ikastola').style.display = 'inline-block';

				ekitaldiak = document.querySelector('#ikastola #ekitaldiak');
